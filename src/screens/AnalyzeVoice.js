...
const AnalyzeVoice = ({ navigation }) => {
    ...
    //                         </Pressable>
    //                         <Pressable onPress={() => { () => navigation.navigate(APP_SCREENS.ADDPRODUCTBULK, { source: APP_SCREENS.ADD_BY_VOICE, resultText: results }) }} style={[styles.button, { backgroundColor: '#32CD32' }]}>
